...
$title = "Edit Music {$music->getSubject()} ";
$bodyClass = "edit";

ob_start(); ?>
    <h1><?= $title ?></h1>
    <form action="<?= $router->generatePath('music-edit') ?>" method="music" class="edit-form">
    ...
    <ul class="action-list">
        ...
        <li>
            <form action="<?= $router->generatePath('music-delete') ?>" method="music">
